...
import { 
    Button, Grid, Typography, TextField, FormControl, FormHelperText, Radio, RadioGroup, FormControlLabel 
...
export default class CreateRoomPage extends Component {
    ...
    renderUpdateButtons(){
        return(
            <Grid item xs={12} align="center">
                <Button color='secondary' variant='contained' onClick={this.handleUpdateButtonPressed}>Update Room</Button>
            </Grid>
        ); 
    }

    render() {
        const title = this.props.update ? "Your room settings" : "Create Room";
